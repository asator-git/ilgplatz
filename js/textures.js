...
function makeIcons(scene) {
  ...
  ic('ic_broken', (p) => { p(1, 1, 3, 3, '#ff4d6d'); p(5, 1, 3, 3, '#ff4d6d'); p(1, 3, 3, 2, '#ff4d6d'); p(5, 3, 3, 2, '#ff4d6d'); p(2, 5, 2, 2, '#ff4d6d'); p(5, 5, 2, 2, '#ff4d6d'); p(3, 7, 1, 1, '#ff4d6d'); p(5, 7, 1, 1, '#ff4d6d'); });
